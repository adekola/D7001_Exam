...
public class MobileAgentGui extends JFrame implements ActionListener
{
  ...
  private  static String CREATELABEL ="CREATE";
	...
	public void actionPerformed(ActionEvent e)
	{
      ...
      GuiEvent ev = new GuiEvent(null,myAgent.EXIT);
			myAgent.postGuiEvent(ev);
                ...
                else if (command.equalsIgnoreCase(CREATELABEL)) {
      GuiEvent ev = new GuiEvent((Object)this,myAgent.CREATE_EVENT);
			myAgent.postGuiEvent(ev);
		}
